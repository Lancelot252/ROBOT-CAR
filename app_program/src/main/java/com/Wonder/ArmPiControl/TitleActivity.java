...
public class TitleActivity extends Activity implements View.OnClickListener {
    ...
    private void setupViews() {
        ...
        titleActivityLayout = (LinearLayout) findViewById(R.id.titleActivity);
    ...
    public void setLeftBtn(boolean back) {
        if (back) {
            leftBtn.setImageResource(R.drawable.back_arrow);
        } else {
            leftBtn.setImageResource(R.drawable.help);
        }
    }
